...
def test_count_good_rectangles():
    ...
    print(solution.countGoodRectangles(rectangles))  # Expected output: 2

    # Test case 3
    rectangles = [[1, 1], [2, 2], [3, 3], [4, 4]]
    print(solution.countGood_rectangles(rectangles))  # Expected output: 1

    # Test case 4
    rectangles = [[5, 5], [5, 5], [5, 5], [5, 5]]
    print(solution.countGood_rectangles(rectangles))  # Expected output: 4
