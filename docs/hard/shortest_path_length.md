...
Return <i>the length of the shortest path that visits every node</i>. You may start and stop at any node, you may revisit nodes multiple times, and you may reuse edges.

**LeetCode Problem**: [View on LeetCode](https://leetcode.com/problems/shortest-path-visiting-all-nodes/description/)
