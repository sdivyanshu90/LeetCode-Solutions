...
Given an integer array `nums` and an integer `k`, return the number of <b>good subarrays</b> of `nums`.
...
**LeetCode Problem**: [View on LeetCode](https://leetcode.com/problems/subarrays-with-k-different-integers/description/)
