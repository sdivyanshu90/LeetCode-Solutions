...
This is a LeetCode hard problem: Count Vowel Permutation

**LeetCode Problem**: [View on LeetCode](https://leetcode.com/problems/count-vowels-permutation/description/)
