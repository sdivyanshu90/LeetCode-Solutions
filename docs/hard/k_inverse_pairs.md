...
This is a LeetCode hard problem: K Inverse Pairs
...
def test_k_inverse_pairs():
    ...
    n = 3
    k = 0
    print(s.kInversePairs(n, k))  # Expected output: 1
    n = 3
    k = 1
    print(s.kInversePairs(n, k))  # Expected output: 2
    n = 4
    k = 2
    print(s.kInversePairs(n, k))  # Expected output: 5
    n = 5
    k = 5
