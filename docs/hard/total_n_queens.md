...
Given an integer `n`, return the number of distinct solutions to the <b>n-queens puzzle</b>.

**LeetCode Problem**: [View on LeetCode](https://leetcode.com/problems/n-queens-ii/description/)
