...
def test_all_one():
    ...
    all_one.inc("hello")
    all_one.inc("hello")
    print(all_one.getMaxKey())  # Expected output: "hello"
    print(all_one.getMinKey())  # Expected output: "hello"

    # Test case 2
    all_one.inc("leet")
    print(all_one.getMaxKey())  # Expected output: "hello"
    print(all_one.getMinKey())  # Expected output: "leet"

    # Test case 3
    all_one.dec("hello")
    print(all_one.getMaxKey())  # Expected output: "leet"
    print(all_one.getMinKey())  # Expected output: "leet"
    ...
    # Test case 5
    all_one.dec("leet")
    print(all_one.getMaxKey())  # Expected output: ""
    print(all_one.getMinKey())  # Expected output: ""
