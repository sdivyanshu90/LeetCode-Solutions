...
def test_delete_duplicate_folder():
    ...
    print(solution.deleteDuplicateFolder(paths2))  # Expected output: [["c"], ["c", "b"], ["w"]]

    # Test Case 3
    paths3 = [["a", "b"], ["c", "d"], ["c"], ["a"]]
    print(solution.deleteDuplicateFolder(paths3))  # Expected output: [["a"], ["c"]]

    # Test Case 4
    paths4 = [["a"], ["a", "x"], ["a", "x", "y"], ["a", "z"]]
    print(solution.deleteDuplicateFolder(paths4))  # Expected output: [["a"], ["a", "z"]]
